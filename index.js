...
const { applyJWT } = require("./app/middlewares/expressJwt");
const { checkAuthenticatedUser } = require("./app/middlewares/checkAuthenticatedUser");
...
app.use(cors(), express.json(), applyJWT(), checkAuthenticatedUser);
